...
// Note: health, forms, and submissions all export GET/POST; import directly
// from each module when you need a specific handler. This barrel re-exports
// only the non-conflicting named exports.
